...
type PyValue = PyConstant | PyCollection[Any]
...
class ExprTree[V: PyValue]:
    @overload
    def __init__[EV: PyValue](self: ExprTree[EV], expr: ExprTree[EV]) -> None: ...
    @overload
    def __init__(self: ExprTree[Any], expr: str) -> None: ...
    # TODO: Encode full ClassAd operator domain relations
    def __add__[OV: PyValue](
        self, other: ExprTree[OV] | OV
    ) -> ExprTree[V | OV | _EU]: ...
    def __sub__[OV: PyValue](
        self, other: ExprTree[OV] | OV
    ) -> ExprTree[V | OV | _EU]: ...
    def __mul__[OV: PyValue](
        self, other: ExprTree[OV] | OV
    ) -> ExprTree[V | OV | _EU]: ...
    def __truediv__[OV: PyValue](
        self, other: ExprTree[OV] | OV
    ) -> ExprTree[V | OV | _EU]: ...
    def __mod__[OV: PyValue](
        self, other: ExprTree[OV] | OV
    ) -> ExprTree[V | OV | _EU]: ...
    def __lshift[OV: PyValue](
        self, other: ExprTree[OV] | OV
    ) -> ExprTree[V | OV | _EU]: ...
    def __rshift[OV: PyValue](
        self, other: ExprTree[OV] | OV
    ) -> ExprTree[V | OV | _EU]: ...
    def __and__[OV: PyValue](
        self, other: ExprTree[OV] | OV
    ) -> ExprTree[V | OV | _EU]: ...
    def __or__[OV: PyValue](
        self, other: ExprTree[OV] | OV
    ) -> ExprTree[V | OV | _EU]: ...
    def __xor__[OV: PyValue](
        self, other: ExprTree[OV] | OV
    ) -> ExprTree[V | OV | _EU]: ...
    def __getitem__[LV: PyValue](self: ExprTree[list[LV]], key: int) -> V: ...
    def __bool__(self) -> bool: ...
    def __eq__(self, other: ExprTree[Any] | PyValue) -> ExprTree[bool | _EU]: ...
    def __ne__(self, other: ExprTree[Any] | PyValue) -> ExprTree[bool | _EU]: ...
    def __ge__(self, other: ExprTree[Any] | PyValue) -> ExprTree[bool | _EU]: ...
    def __gt__(self, other: ExprTree[Any] | PyValue) -> ExprTree[bool | _EU]: ...
    def __le__(self, other: ExprTree[Any] | PyValue) -> ExprTree[bool | _EU]: ...
    def __lt__(self, other: ExprTree[Any] | PyValue) -> ExprTree[bool | _EU]: ...
    def and_[OV: PyValue](self, expr: ExprTree[OV] | OV) -> ExprTree[V | OV | _EU]: ...
    def or_[OV: PyValue](self, expr: ExprTree[OV] | OV) -> ExprTree[V | OV | _EU]: ...
    def is_(self, expr: ExprTree[Any] | PyValue) -> ExprTree[bool]: ...
    def isnt_(self, expr: ExprTree[Any] | PyValue) -> ExprTree[bool]: ...
    def sameAs(self, expr: ExprTree[Any] | PyValue) -> ExprTree[bool]: ...
    def eval(
        self,
...
class ClassAd[V: PyValue]:
    @overload
    def __init__[CV: PyValue](self: ClassAd[CV], input: ClassAd[CV]) -> None: ...
    @overload
    def __init__[DV: PyValue](
        self: ClassAd[DV],
        input: (
    ...
    @overload
    def __init__[DV: PyValue, DDV: PyValue](
    ...
    @overload
    def update[CV: PyValue](self: ClassAd[CV], other: ClassAd[CV], /) -> None: ...
    @overload
    def update[DV: PyValue](
        self: ClassAd[DV],
        other: dict[str, DV | ExprTree[DV]] | Iterable[tuple[str, DV | ExprTree[DV]]],
        /,
    ) -> None: ...
    @overload
    def update[DV: PyValue, DDV: PyValue](
        self: ClassAd[DV | dict[str, DDV]],
        other: (
            Mapping[str, DV | ExprTree[DV] | Mapping[str, ClassAd[DDV]]]
            | Iterable[tuple[str, DV | ExprTree[DV]] | Mapping[str, ClassAd[DDV]]]
...
def lastError() -> str: ...
def register(function: Callable[..., PyValue], name: str | None = None) -> None: ...
