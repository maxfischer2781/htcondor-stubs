...
class Negotiator:
    def __init__(self, ad: ClassAd[Any] | None) -> None: ...
    def resetAllUsage(self) -> None: ...
    def deleteUser(self, user: str) -> None: ...
    def resetUsage(self, user: str) -> None: ...
    def setBeginUsage(self, user: str, value: int) -> None: ...
    def setCeiling(self, user: str, ceiling: float) -> None: ...
    def setFactor(self, user: str, factor: float) -> None: ...
    def setLastUsage(self, user: str, value: int) -> None: ...
    def setPriority(self, user: str, prio: float) -> None: ...
...
class DrainTypes(enum.IntEnum):
    Fast = 20
    Graceful = 0
    Quick = 10
    names: ClassVar[dict[str, DrainTypes]]
    values: ClassVar[dict[int, DrainTypes]]

class Startd:
    def __init__(self, ad: ClassAd[Any] | None) -> None: ...
    def drainJobs(
        self,
        drain_type: DrainTypes | int = DrainTypes.Graceful,
        on_completion: int = 0,
        check_expr: str | ExprTree[bool] = "true",
        start_expr: str | ExprTree[bool] = "false",
        reason: str = "by command",
    ) -> str: ...
    def cancelDrainJobs(self, request_id: str = "") -> None: ...
    def history(
        self,
        requirements: str | ExprTree[bool],
        projection: list[str],
        match: int = -1,
    ) -> HistoryIterator: ...
